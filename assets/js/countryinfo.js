...
function getParams() {
  ...
  upsplashGetPhotoUrl =
    "https://api.unsplash.com/photos/?client_id=" + upsplashAccessKey + "&id=";
...
function countryInfoCard() {
  ...
  languageSpoken.textContent =
    " Language spoken: " + countryData.language[0].language;
  // electricity.textContent = searchHistory.electricity
  volt.textContent = " Voltage: " + countryData.electricity.voltage;
  frequency.textContent =
    " Electricity frequency: " + countryData.electricity.frequency;
...
function emergency() {
  ...
  callingCode.textContent =
    " Calling Code: " + countryData.telephone.calling_code;
